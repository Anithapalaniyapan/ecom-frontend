...
export default function ShoesPage() {
  ...
  React.useEffect(() => {
    (async () => {
      try {
        const resCat = await fetch('http://localhost:3000/api/categories/type/shoes');
        ...
        console.error('Failed to load shoes products', e);
      }
    })();
  }, []);
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>Shoes</Typography>
